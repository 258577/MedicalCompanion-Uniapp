				...
				<view>
					<view class="modal-main" style="background: #f4f4f4">
						<view class="modal-hd">
							...
							<image class="modal-hd-closer" src="../../static/resource/modal_closer.png" mode="widthFix" @tap="hideShareModal" />
						</view>
						<view class="modal-bd">
									...
									<view class="vp-flex">
										<view class="vp-flex_1">
											<button open-type="share" class="push-type">
												<view class="push-icon"><image src="../../static/resource/push_wx.png" mode="widthFix" /></view>
												<view class="push-text"><text>发给微信好友</text></view>
											</button>
										</view>
										<view class="vp-flex_1">
											<view class="push-type" @tap="shareByPoster">
												<view class="push-icon"><image src="../../static/resource/push_img.png" mode="widthFix" /></view>
