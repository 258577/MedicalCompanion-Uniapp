	...
	<view>
		<view class="op-cells" style="background-color: #ffffff; padding: 0 0 60rpx 0; overflow: hidden; text-align: center">
			<view style="margin-top: 40rpx">
				<view style="display: inline-block; width: 150rpx; height: 150rpx; border-radius: 200rpx; overflow: hidden">
					...
					<block v-else>
						<image src="../../static/resource/avatar.jpg" style="width: 150rpx; height: 150rpx" />
					</block>
				</view>
			</view>
		...
		<view class="weui-cells op-cells" style="margin-top: 20rpx">
			<view class="weui-cell">
				...
				<view class="quanbu"><text @tap="toOrders" style="font-size: 26rpx">全部</text></view>
			</view>
			<view class="weui-cell" style="padding: 0">
				<view class="weui-cell__bd">
					<view class="data-cell" hover-class="weui-cell_active" @tap="toOrders" data-filt="1">
						<view class="data-icon"><image src="../../static/resource/od_10.png" mode="widthFix" /></view>
				...
				<view class="weui-cell__bd">
					<view class="data-cell" hover-class="weui-cell_active" @tap="toOrders" data-filt="2">
						<view class="data-icon"><image src="../../static/resource/od_20.png" mode="widthFix" /></view>
				...
				<view class="weui-cell__bd">
					<view class="data-cell" hover-class="weui-cell_active" @tap="toOrders" data-filt="3">
						<view class="data-icon"><image src="../../static/resource/od_30.png" mode="widthFix" /></view>
						<view class="data-txt">已完成</view>
					</view>
				</view>
				<view class="weui-cell__bd">
					<view class="data-cell" hover-class="weui-cell_active" @tap="toOrders" data-filt="4">
						<view class="data-icon"><image src="../../static/resource/od_40.png" mode="widthFix" /></view>
		...
		<view class="weui-cells op-cells" style="margin-top: 20rpx">
			<view class="weui-cell weui-cell_access" hover-class="weui-cell_active" @click="guanli">
				<view class="weui-cell__hd">
					<image src="../../static/resource/ic_clients.png" style="display: block; margin-right: 20rpx; width: 20px; height: 20px"></image>
				</view>
			...
			<view class="weui-cell weui-cell_access" hover-class="weui-cell_active" @tap="showShareModal">
				<view class="weui-cell__hd">
					<image src="../../static/resource/ic_share.png" style="display: block; margin-right: 20rpx; width: 20px; height: 20px"></image>
				</view>
